...
- fix: Status bar item has bad contrast [#503](https://github.com/tjx666/vscode-colorize/issues/503)

## 0.12.1

### Fix

- fix: haven't check color front boundary [#574](https://github.com/tjx666/vscode-colorize/issues/574)
...
- colorize.exclude doesn't work [#731](https://github.com/tjx666/vscode-colorize/issues/731) [#417](https://github.com/tjx666/vscode-colorize/issues/417)
...
- [FIX] [#291](https://github.com/tjx666/vscode-colorize/issues/291) Remove Alpha value in ARGB only if alpha is defined

## 0.8.11

- [FIX] [#264](https://github.com/tjx666/vscode-colorize/issues/264) Colorize hexa colors starting with `0x`

## 0.8.10

- [FEATURE] [#226](https://github.com/tjx666/vscode-colorize/issues/226) Add colorization for ARGB colors
...
- [FIX] [#106](https://github.com/tjx666/vscode-colorize/issues/106) - Decorations were not disable for a line accessed from a deletion. Also hide decorations on default selected line on file opening.
- [FIX] [#112](https://github.com/tjx666/vscode-colorize/issues/112) - Improve decorations contrast (between background and text) by following the WCAG guidelines ([Contrast (Enhanced)](https://www.w3.org/WAI/WCAG20/quickref/#qr-visual-audio-contrast7) and [Contrast (Minimum)](https://www.w3.org/WAI/WCAG20/quickref/#visual-audio-contrast-contrast))
- [FIX] [#113](https://github.com/tjx666/vscode-colorize/issues/113) - SASS and LESS variables like `$var_1A`, $var_A` and `$var-1` were extracted but not colorized.

## 0.6.11

- [FIX] [#97](https://github.com/tjx666/vscode-colorize/issues/97) - find closest declarations on windows not working due to trailing `\`
...
- [FIX] [#76](https://github.com/tjx666/vscode-colorize/issues/76) - Now spaces between variables names and declarations delimiters are accepted. It means this `$myVar : #ffffff` is a valid variable declaration
...
- [FIX] [#62](https://github.com/tjx666/vscode-colorize/issues/62) variables not deleted
...
- [FIX] [#61](https://github.com/tjx666/vscode-colorize/issues/61) New variables not colorized
...
- [FIX] [#35](https://github.com/tjx666/vscode-colorize/issues/35) Should prevent no longer have side effects on other extensions

## 0.4.2

- [FIX] [#28](https://github.com/tjx666/vscode-colorize/issues/28), now `.x` is a valid alpha value
...
- [FIX] [#26](https://github.com/tjx666/vscode-colorize/issues/26) Do not colorize browsers colors inside a word
...
- [FIX] [#20](https://github.com/tjx666/vscode-colorize/issues/20) Support for split view
- [FIX] [#11](https://github.com/tjx666/vscode-colorize/issues/11) Colorize all colors in gradient statement
- [ADD] Cross browser colors extraction (#12)
- [FIX] [#13](https://github.com/tjx666/vscode-colorize/issues/13) Add a settings options to easily add new languages support
