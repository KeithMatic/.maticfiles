...
return {
  ...
  NeoTreeTabSeperatorActive = { fg = "none", bg = "none" },
  NeoTreeTabSeperatorInactive = { fg = "none", bg = "none" },
  NvimTreeTabSeperatorActive = { fg = "nonne", bg = "none" },
  NvimTreeTabSeperatorInactive = { fg = "none", bg = "none" },
  MiniTabLineFill = { fg = "none", bg = "none" },
  -- Spectre
